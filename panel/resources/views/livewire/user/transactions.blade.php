                    ...
                    <tr aria-rowindex="{{ $loop->index }}">
                        ...
                        <td aria-colindex="3" class="d-none d-md-table-cell blz-md-15 align-middle text-nowrap">
                            ...
                            @if($item->service === 'withdraw')
                                <div data-v-70ad3292="" class="text-nowrap d-flex align-items-center justify-content-end
                             justify-content-md-start">
                                <span data-v-70ad3292="" title="@lang('account.status_'.$item->status)"
                                      class="text-truncate
                                    blz-text-capitalize-first blz-mw-100px">@lang('account.status_'.$item->status)</span>
                            </div>
                            @else
                                <div data-v-70ad3292="" class="text-nowrap d-flex align-items-center justify-content-end
                             justify-content-md-start">
