...
>
    ...
    <div class="Navbar-container">
        <nav class="Navbar-mobile">
            ...
            <a href="{{ route('home.index') }}" class="Navbar-logo" data-analytics="global-nav" data-analytics-placement="Nav - Icon"></a>
            <a href="{{ route('home.index') }}" class="Navbar-customLogo"></a>
        ...
        <nav class="Navbar-desktop">
            ...
            <div class="Navbar-items">
                <a href="{{ route('home.index') }}" class="Navbar-item Navbar-link is-noSelect Navbar-home" data-index='1' data-name="home" data-analytics="global-nav" data-analytics-placement="Nav - Home">
            ...
            <div class="Navbar-profileItems">
                @if (Laravel\Jetstream\Jetstream::hasApiFeatures())
                    <a href="{{ route('api-tokens.index') }}" class="Navbar-support Navbar-item Navbar-link is-noSelect" data-index="0" data-name="support" data-analytics="global-nav" data-analytics-placement="Nav - Support"><div class="Navbar-label">{{ __('API Tokens') }}</div></a>
                @endif

                <a href="https://community.nighthold.pro/forums/texnicheskaja-podderzhka.8/" class="Navbar-support Navbar-item Navbar-link is-noSelect" data-index="0"
                   data-name="support" data-analytics="global-nav" data-analytics-placement="Nav - Support"><div class="Navbar-label">{{ __('navbar.navbar_3') }}</div><div class="Navbar-supportCounter">0</div></a>
                <a data-target="Navbar-accountDropdown" data-name="account" class="Navbar-account Navbar-item Navbar-modalToggle is-noSelect">
                    ...
                    <div class="Navbar-label Navbar-accountAuthenticated">{{ Str::title(Auth::user()->forum->username ?? '%USER_TAG_FULL%') }}</div>
                    ...
                    <div class="Navbar-accountDropdownLoggedIn">
                        <div class="Navbar-modalSection">
                            <div class="Navbar-accountDropdownProfileInfo">
                                <div class="Navbar-accountDropdownBattleTag">{{ Str::title(Auth::user()->forum->username ?? '%USER_TAG_FULL%') }}</div>
                                <div class="Navbar-accountDropdownBattleTagNumber"></div>
                            </div>
                            <div class="Navbar-accountDropdownEmail">{{ Auth::user()->email ?? '%USER_EMAIL%' }}</div>
                        </div>

                        <a href="{{ route('dashboard') }}" class="Navbar-accountDropdownLink Navbar-accountDropdownSettings"
...
document.getElementById('logout-form').submit();" class="Navbar-accountDropdownLink" data-analytics="global-nav" data-analytics-placement="Nav - Account - Log Out">
        ...
        <div class="Navbar-modal Navbar-accountModal is-animated is-scroll-blocking">
            <div class="Navbar-modalContent">
                ...
                <a href="{{ route('home.index') }}" class="Navbar-logo Navbar-mobileModalLogo" data-analytics="global-nav" data-analytics-placement="Nav - Icon"></a>
                <div class="Navbar-accountDropdownLoggedIn">
                    <div class="Navbar-modalSection">
                        <div class="Navbar-accountDropdownProfileInfo">
                            <div class="Navbar-accountDropdownBattleTag">{{ Str::title(Auth::user()->forum->username ?? '%USER_TAG_FULL%') }}</div>
...
document.getElementById('logout').submit();" class="Navbar-accountDropdownLink" data-analytics="global-nav" data-analytics-placement="Nav - Account - Log Out">
                        <div class="Navbar-icon Navbar-accountDropdownLinkIcon">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 64 64" focusable="false">
                                <use xlink:href="#Navbar-icon-logout"></use></svg>
                        </div>
                        <div class="Navbar-accountDropdownLinkLabel">{{ __('navbar.navbar_7') }}
                        </div>
                    </a>
                ...
                <a href="{{ route('home.index') }}" class="Navbar-modalLink is-noSelect" data-analytics="global-nav"
                   data-analytics-placement="Nav - Icon"><div class="Navbar-modalLinkLabel">{{ __('navbar.navbar_8') }}</div></a>
        ...
        <div data-compact-mode="true" class="Navbar-modal Navbar-siteMenu is-animated is-scroll-blocking">
            <div class="Navbar-modalContent">
                <div class="mobile-menu-content">
                    <div class="side-navigation">
                        <ul class="nav">
                            <li data-v-91f16f3e="">
                                <a data-v-91f16f3e="" href="https://nighthold.pro/game/start" target="_blank" rel="noopener">
                                    <span data-v-91f16f3e="" class="icon icon-external-link"></span>
                                    <span data-v-91f16f3e="" class="text external-link">@lang('menu.menu_1')</span>
                                </a>
                            </li>
                            <hr>
                            <li data-v-91f16f3e="">
                                <x-jet-responsive-nav-link data-v-91f16f3e="" href="{{ route('dashboard') }}" :active="request()
                    ->routeIs('dashboard')">
                                    <span data-v-91f16f3e="" class="icon icon-home"></span>
                                    <span data-v-91f16f3e="" class="text">@lang('menu.menu_2')</span>
                                </x-jet-responsive-nav-link>
                            </li>
                            <hr>
                            <li data-v-91f16f3e="">
                                <x-jet-responsive-nav-link data-v-91f16f3e="" href="{{ route('profile.detail') }}" :active="request()
                    ->routeIs('profile.detail')">
                                    <span data-v-91f16f3e="" class="icon icon-user"></span>
                                    <span data-v-91f16f3e="" class="text">@lang('menu.menu_3')</span>
                                </x-jet-responsive-nav-link>
                            </li>
                            <li data-v-91f16f3e="">
                                <x-jet-responsive-nav-link data-v-91f16f3e="" href="{{ route('profile.characters') }}"
                                                           :active="request()
                    ->routeIs('profile.characters')">
                                    <span data-v-91f16f3e="" class="icon icon-user"></span>
                                    <span data-v-91f16f3e="" class="text">@lang('menu.menu_4')</span>
                                </x-jet-responsive-nav-link>
                            </li>
                            <li data-v-91f16f3e="">
                                <x-jet-responsive-nav-link data-v-91f16f3e="" href="{{ route('profile.services') }}"
                                                           :active="request()
                    ->routeIs('profile.services')">
                                    <span data-v-91f16f3e="" class="icon icon-user"></span>
                                    <span data-v-91f16f3e="" class="text">@lang('menu.menu_5')</span>
                                </x-jet-responsive-nav-link>
                            </li>
                            <hr>
                            <li data-v-91f16f3e="">
                                <x-jet-responsive-nav-link href="{{ route('profile.referrals') }}" :active="request()
                    ->routeIs('profile.referrals')" data-v-91f16f3e="">
                                    <span data-v-91f16f3e="" class="icon icon-user-friends"></span>
                                    <span data-v-91f16f3e="" class="text">@lang('menu.menu_6')</span>
                                </x-jet-responsive-nav-link>
                            </li>
                            <li data-v-91f16f3e="">
                                <x-jet-responsive-nav-link href="{{ route('profile.vote') }}" :active="request()
                    ->routeIs('profile.vote')" data-v-91f16f3e="">
                                    <span data-v-91f16f3e="" class="icon icon-external-link"></span>
                                    <span data-v-91f16f3e="" class="text">@lang('menu.menu_8')</span>
                                </x-jet-responsive-nav-link>
                            </li>
                            <hr>
                            <li data-v-91f16f3e="">
                                <x-jet-responsive-nav-link data-v-91f16f3e="" href="{{ route('profile.games') }}" :active="request()
                    ->routeIs('profile.games')">
                                    <span data-v-91f16f3e="" class="icon icon-list"></span>
                                    <span data-v-91f16f3e="" class="text">@lang('menu.menu_9')</span>
                                </x-jet-responsive-nav-link>
                            </li>
                            <li data-v-91f16f3e="">
                                <x-jet-responsive-nav-link data-v-91f16f3e="" href="{{ route('profile.connections') }}" :active="request()
                        ->routeIs('profile.connections')">
                                    <span data-v-91f16f3e="" class="icon icon-link"></span>
                                    <span data-v-91f16f3e="" class="text">@lang('menu.menu_10')</span>
                                </x-jet-responsive-nav-link>
                            </li>
                            <hr>
                            <li data-v-91f16f3e="">
                                <x-jet-responsive-nav-link data-v-91f16f3e="" href="{{ route('profile.security') }}"
                                                           :active="request()->routeIs('profile.security')">
                                    <span data-v-91f16f3e="" class="icon icon-shield"></span>
                                    <span data-v-91f16f3e="" class="text">@lang('menu.menu_11')</span>
                                </x-jet-responsive-nav-link>
                            </li>
                            <hr>
                            <li data-v-91f16f3e="">
                                <x-jet-responsive-nav-link data-v-91f16f3e="" href="{{ route('profile.payment') }}"
                                                           :active="request()->routeIs('profile.payment')">
                                    <span data-v-91f16f3e="" class="icon icon-credit-card"></span>
                                    <span data-v-91f16f3e="" class="text">@lang('menu.menu_12')</span>
                                </x-jet-responsive-nav-link>
                            </li>
                            <li data-v-91f16f3e="">
                                <x-jet-responsive-nav-link data-v-91f16f3e="" href="{{ route('profile.transactions') }}"
                                                           :active="request()->routeIs('profile.transactions')">
                                    <span data-v-91f16f3e="" class="icon icon-shopping-cart"></span>
                                    <span data-v-91f16f3e="" class="text">@lang('menu.menu_13')</span>
                                </x-jet-responsive-nav-link>
                            </li>
                            <hr>
                        </ul>
