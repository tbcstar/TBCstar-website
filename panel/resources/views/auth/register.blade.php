<x-guest-layout>
    <x-jet-authentication-card>
        <div class="step" id="step-root">
            ...
            <div class="step__content step__block" id="flow-content-container">
                ...
                <h1 class="step__title step__block">开始</h1>
                <p class="step__description step__block">请填写下面所有的字段以创建账户。</p>
                    ...
                    <div class="step__field step__form__block">
                        ...
                        <span class="step__tooltip">
                                <span class="step__tooltip__anchor">
                                    <span class="step__tooltip__description">用于登录游戏。可以包含英文字母和数字。</span>
                                </span>
  ...
  <path d="M5.255 5.786a.237.237 0 0 0 .241.247h.825c.138 0 .248-.113.266-.25.09-.656.54-1.134 1.342-1.134.686 0 1.314.343 1.314 1.168 0 .635-.374.927-.965 1.371-.673.489-1.206 1.06-1.168 1.987l.003.217a.25.25 0 0 0 .25.246h.811a.25.25 0 0 0 .25-.25v-.105c0-.718.273-.927 1.01-1.486.609-.463 1.244-.977 1.244-2.056 0-1.511-1.276-2.241-2.673-2.241-1.267 0-2.655.59-2.75 2.286zm1.557 5.763c0 .533.425.927 1.01.927.609 0 1.028-.394 1.028-.927 0-.552-.42-.94-1.029-.94-.584 0-1.009.388-1.009.94z"/>
                    ...
                    <div class="step__field step__form__block">
                        ...
                        <span class="step__tooltip">
                                <span class="step__tooltip__anchor">
                                    <span class="step__tooltip__description">TBCstarTag是您的公共用户名（昵称），在论坛上使用，所有其他玩家都可以看到。不能与您的登录名相同。</span>
                                </span>
                                <span class="step__tooltip__title">
                                    <span class="step__input-addon--show-password">
<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-question-circle" viewBox="0 0 16 16">
  ...
  <path d="M5.255 5.786a.237.237 0 0 0 .241.247h.825c.138 0 .248-.113.266-.25.09-.656.54-1.134 1.342-1.134.686 0 1.314.343 1.314 1.168 0 .635-.374.927-.965 1.371-.673.489-1.206 1.06-1.168 1.987l.003.217a.25.25 0 0 0 .25.246h.811a.25.25 0 0 0 .25-.25v-.105c0-.718.273-.927 1.01-1.486.609-.463 1.244-.977 1.244-2.056 0-1.511-1.276-2.241-2.673-2.241-1.267 0-2.655.59-2.75 2.286zm1.557 5.763c0 .533.425.927 1.01.927.609 0 1.028-.394 1.028-.927 0-.552-.42-.94-1.029-.94-.584 0-1.009.388-1.009.94z"/>
                ...
                <div class="step__block">已有帐户？ <a href="{{ route('login') }}">登录</a>
                </div>
            </div>
        </div>
