            ...
            <div class="react-mount" id="realm-status-mount" data-initial-state-variable-name="realmStatusInitialState">
                <div tabindex="-1" locale="ru-RU" style="outline: none;">
                    <div class="Pane Pane--underSiteNav Pane--bgTop " data-queryselectoralways-ignore="true" queryselectoralways="31">
                        <div class="Pane-bg" data-background-image="{{ asset
                             ('cms/template_resource/1620896874_27.jpg') }}" data-loaded="true"
                             style="background-color: rgb(9, 12, 29); background-image: url({{ asset
                             ('cms/template_resource/1620896874_27.jpg') }});">
                            <div class="Pane-overlay"></div>
                        </div>
                        <div class="Pane-content">
                            <div class="padding-top-huge margin-bottom-large">
                                <div class="contain-masthead align-center">
                                    <div class="font-semp-xxxLarge-white">Список патчей</div>
                                    <div class="space-rhythm-medium"></div>
                                    <div class="Content">
                                        <span class="font-bliz-light-small-beige">Данные файлы предназначены для ручной загрузки, в случае если у вас не запускается лаунчер , при ручной загрузке следует контролировать дату обновления файла и загружать вручную заново.
                                        </span>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="HorizontalNav HorizontalNav--flex HorizontalNav--gutters">
                                            <div class="HorizontalNav-itemsContainer">
                                                <div class="MediaAwareSlider MediaAwareSlider--disabled HorizontalNav-items">
                                                    <a href="{{ route('addons.index') }}" class="HorizontalNav-link"
                                                       type="button">
                                ...
                                <div class="SortTable SortTable--flex" data-queryselectoralways-ignore="true" queryselectoralways="44">
                                    <div class="SortTable-head">
                                        <div class="SortTable-col SortTable-label">
                                            <button class="SortTable-labelOuter align-left">
                                                <div class="SortTable-labelInner">
                                                    <div class="SortTable-labelText">Название вместе с директорией</div>
                                                </div>
                                            </button>
                                        </div>

                                        <div class="SortTable-col SortTable-label">
                                            <button class="SortTable-labelOuter align-right">
                                                <div class="SortTable-labelInner">
                                                    <div class="SortTable-labelText">Дата обновления</div>
                                                </div>
                                            </button>
                                        </div>
                                        <div class="SortTable-col SortTable-label">
                                            <button class="SortTable-labelOuter align-right">
                                                <div class="SortTable-labelInner">
                                                    <div class="SortTable-labelText">Ссылка на скачивание</div>
                                                </div>
                                            </button>
                                        </div>
                                    </div>
                                    <div class="SortTable-body">
                                        <livewire:game.patch-list />
                                    </div>
                                </div>
                            </div>
                        </div>
