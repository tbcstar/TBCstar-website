...
<head>
    ...
    <meta name="blizzard-app-version" content="5.4.29">
    <meta name="viewport" content="width=device-width, initial-scale=1, user-scalable=no">
    <meta name="description" content="Спешите установить приложение, позволяющее оставаться на связи, играть и узнавать о новинках.">
    <meta name="theme-color" content="#000b3a">
    <link rel="stylesheet" href="https://d9me64que7cqs.cloudfront.net/blizzardNavbar.7d86a0ef1337033eb92f.css">
    <link rel="stylesheet" href="https://d9me64que7cqs.cloudfront.net/app.b587771d261df9e4f05e.css">
    <link rel="stylesheet" href="https://d9me64que7cqs.cloudfront.net/bnet-desktop.64e5329b9bbc233c1c0c.css">
</head>
<body lang="ru" data-locale="ru-ru" data-name="unknown" data-device="desktop" data-platform="windows">
<div class="Overlay Page-navigation Overlay--top">
    <div class="Overlay-content">
        <nav class="Navbar is-auto is-top" aria-label="Меню навигации">
            ...
            <div class="Navbar-container">
                <div class="Navbar-skipLinks" id="skip-link-container" role="presentation">
                    <a class="Navbar-skipLink" id="main-skip-link" href="#mainContent">Перейти к основному контенту</a>
                    <a class="Navbar-skipLink" id="footer-skip-link" href="#global-navbar-footer">Перейти в конец страницы</a>
                </div>
                <div class="Navbar-mobile">
                    <div role="presentation" class="Navbar-mobileOverlay Navbar-overlay"></div>
                    <a data-target="Navbar-siteMenu" data-site-mode="true" aria-label="Меню" role="button" tabindex="0" aria-haspopup="true" class="Navbar-menu Navbar-modalToggle is-noSelect"><div class="Navbar-icon Navbar-mobileIcon Navbar-siteMenuIcon"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 48 48" focusable="false" aria-hidden="true"><use xlink:href="#Navbar-icon-menu"></use></svg></div>
                    </a>
                    <a href="{{ url('/') }}" class="Navbar-logo" data-analytics="global-nav"
                       data-analytics-placement="Nav - Icon"><div class="Navbar-label">Главная</div></a>
                    <div role="presentation" class="Navbar-profileItems">
                        <a role="button" aria-haspopup="true" aria-label="Open Secondary Menu" data-target="Navbar-accountModal" tabindex="0" class="Navbar-account Navbar-modalToggle is-noSelect">
                            <div class="Navbar-icon Navbar-mobileIcon Navbar-profileIcon">
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 48 48" focusable="false" aria-hidden="true"><use xlink:href="#Navbar-icon-profile"></use></svg>
                            </div>
                        </a>
                    </div>
                </div>
                <div class="Navbar-desktop">
                    ...
                    <div class="Navbar-items">
                        <a href="/" class="Navbar-item Navbar-link is-noSelect Navbar-shop" data-index='1'
                           data-name="shop" tabindex="0" data-analytics="global-nav" data-analytics-placement="Nav -
                           Shop"><div class="Navbar-label">Главная</div>
                        </a>
                        <a href="{{ route('news.index') }}" class="Navbar-item Navbar-link is-noSelect Navbar-news"
                           data-index='2' data-name="news" tabindex="0" data-analytics="global-nav" data-analytics-placement="Nav - News"><div class="Navbar-label">Новости</div></a>
                        <a href="{{ route('forums.index') }}" class="Navbar-item Navbar-link is-noSelect Navbar-news"
                           data-index='2' data-name="news" tabindex="0" data-analytics="global-nav"
                           data-analytics-placement="Nav - News"><div class="Navbar-label">Форум</div></a>
                    </div>
                    <div class="Navbar-profileItems">
                        <a href="https://community.nighthold.pro/forums/texnicheskaja-podderzhka.8/" class="Navbar-support Navbar-item Navbar-link is-noSelect" data-index="0"
                           data-name="support" data-analytics="global-nav" data-analytics-placement="Nav - Support"><div class="Navbar-label">Поддержка</div><div class="Navbar-supportCounter">0</div>
                        </a>
                    </div>
                </div>
            </div>
...
<main class="Page-container" id="mainContent">
    <div class="Page-content ru-RU">
        <div id="react-stub" role="presentation">
            <div class="pageWrapper--3Fh0K" role="presentation">
                <section aria-label="Приложение Battle.net">
                    <div class="container--1orox backgroundClass--xgJ64" style="background-image: url({{ asset('v3/assets/app/Desktop_HeaderBG_Large.webp') }}?auto=webp&amp;format=pjpg);">
                        <div class="headerSection--3muAu contentWrapper--22UAC" role="presentation">
                            <h1 class="heading--3CcII h1--1PK4G uppercase--tFXj1">
                                Приложение {{ config('app.name') }}
                            </h1>
                            <a class="button--1oiy_ button--3FAOb" href="{{ setting('links.launcher_win_7_url')
                            }}">Для Windows XP/Vista/7
                                <div class="platformIconClass--2r66z icon--1SZos" aria-hidden="true">
                                    <div class="iconSvg--7rod7"><svg focusable="false" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64"><path d="M30.423 51.603l24.533 3.442V33.677H30.423zM54.956 30.65V8.955l-24.533 3.662V30.65zM9.044 33.677v14.927l18.352 2.575V33.677zM27.396 13.069l-18.352 2.74V30.65h18.352z"></path></svg></div>
                                </div>
                            </a>
                            <a class="button--1oiy_ button--3FAOb"
                               href="{{ setting('links.launcher_url') }}">Для Windows 8/10/11
                                <div class="platformIconClass--2r66z icon--1SZos" aria-hidden="true">
                                    <div class="iconSvg--7rod7"><svg focusable="false" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64"><path d="M30.423 51.603l24.533 3.442V33.677H30.423zM54.956 30.65V8.955l-24.533 3.662V30.65zM9.044 33.677v14.927l18.352 2.575V33.677zM27.396 13.069l-18.352 2.74V30.65h18.352z"></path></svg></div>
                                </div>
                            </a>
                            <img class="image--37QoI" src="{{ asset('v3/assets/app/2021-09-12_18-11-02.png') }}" alt="Скриншот приложения">
                        </div>
                    </div>
                </section>
            </div>
