                ...
                <div class="Navbar-modalContent">
                    <div class="Navbar-accountDropdownLoggedOut">
                        <div class="Navbar-modalSection">
                            <a href="https://account.nighthold.pro/login" class="Navbar-accountDropdownButtonLink" data-analytics="global-nav" data-analytics-placement="Nav - Account - Log In"><button class="Navbar-button is-full">{{ __('navbar.navbar_5') }}</button></a>
                        </div>
                        ...
                        <a href="https://account.nighthold.pro/register" class="Navbar-accountDropdownLink" data-analytics="global-nav" data-analytics-placement="Nav - Account - Create a Free Account">
                            <div class="Navbar-icon Navbar-accountDropdownLinkIcon">
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 64 64" focusable="false">
        ...
        <div class="Navbar-modal Navbar-accountModal is-animated is-scroll-blocking">
            <div class="Navbar-modalContent">
                ...
                <div class="Navbar-accountDropdownLoggedOut">
                    ...
                    <a href="{{ route('dashboard') }}" class="Navbar-accountDropdownLink Navbar-accountDropdownSettings"
                       data-analytics="global-nav" data-analytics-placement="Nav - Account - Settings"><div class="Navbar-icon Navbar-accountDropdownLinkIcon"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 64 64" focusable="false"><use xlink:href="#Navbar-icon-settings"></use></svg></div><div class="Navbar-accountDropdownLinkLabel">{{ __('navbar.navbar_6') }}</div></a>
                    <a href="https://account.nighthold.pro/register" class="Navbar-accountDropdownLink" data-analytics="global-nav" data-analytics-placement="Nav - Account - Create a Free Account"><div class="Navbar-icon Navbar-accountDropdownLinkIcon"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 64 64" focusable="false"><use xlink:href="#Navbar-icon-account-add"></use></svg></div><div class="Navbar-accountDropdownLinkLabel">{{ __('navbar.navbar_34') }}</div></a>
                </div>
                <div class="Navbar-accountDropdownLoggedIn">
                    <div class="Navbar-modalSection">
                        <div class="Navbar-accountDropdownProfileInfo">
                    ...
                    <div class="BnetNav-mobileSiteMenuBody">
                        ...
                        <div class="BnetNav-searchInline">
                            <form action="{{ route('search') }}" method="GET">
                                ...
                                <input class="BnetNav-searchInlineInput" id="searchInlineInput" name="q" type="search" placeholder="Что вы ищете?" autocomplete="off"></form>
                        </div>
                        <div class="space-normal"></div>
                        @include('menu.mobileSiteMenuList')
                    </div>
                </div>

                <div class="Navbar-modalClose Navbar-icon" data-target=".Navbar-menu.is-active" tabindex="0" role="button" aria-label="Закрыть меню"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 64 64" focusable="false" aria-hidden="true"><use xlink:href="#Navbar-icon-close"></use></svg>
                </div>
            </div>
            <div class="Navbar-modalCloseGutter"></div>
        </div>
