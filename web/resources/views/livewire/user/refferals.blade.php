                    ...
                    <div data-v-21c799d2="" data-v-15d61d2e="" class="row mt-3 mt-md-3">
                        ...
                        <div class="col-12 col-md-8 text-truncate">
                            <span data-v-15d61d2e="" class="" data-v-19975e4f="">
                                {{ config('app.url') . "?ref=" . Hashids::encode(auth()->user()->id) }}
                            </span>
                        </div>
                    </div>
                    <div data-v-21c799d2="" data-v-15d61d2e="" class="row mt-3 mt-md-3">
                         ...
                         b-table table-hover table-dark account-table thead-no-border table-background-transparent">
                            <thead class="thead-dark">
                                <tr>
                                    ...
                                    <th aria-colindex="3" class="w-md-auto">Итого</th>
                            ...
                            @foreach($referrals as $item)
                                ...
                                <tr>
                                    <th aria-colindex="1" class="w-md-auto">Аккаунт ({{ $item->referrer->name }})</th>
                                    <th aria-colindex="2" class="w-md-auto">{{ $item->bonus }} Емблем</th>
                                    <th aria-colindex="3" class="w-md-auto d-none d-md-table-cell">Отыграно {{ Text::totalTime($item->characters->totaltime ?? '0') }}</th>
                                </tr>
                            @endforeach
                            </tbody>
                        </table>
