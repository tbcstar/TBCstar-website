                ...
                <div data-v-7090ae16="" data-v-15d61d2e="" id="redeem-code-form">
                    <div data-v-21c799d2="" data-v-15d61d2e="" class="row">
                        ...
                        <div data-v-21c799d2="" data-v-15d61d2e="" class="col-8 col-md-4">
                            <a href="{{ setting('mmotop.link_mmotop_stats') }}" target="_blank">
                ...
                <div data-v-15d61d2e="" class="account-overview-transactions-table">
                    <div data-v-70ad3292="" data-v-15d61d2e="" class="account-table-container">
                        <table data-v-483e03c5="" data-v-70ad3292="" aria-busy="false" aria-colcount="5"
                               aria-rowcount="-1" sort-direction="asc" class="table b-table table-hover ">
                            <thead class="thead-dark">
                            <tr><th tabindex="0" aria-colindex="1" aria-label="Click to sort Ascending" aria-sort="descending" class="w-md-auto">Дата</th> <th aria-colindex="2" class="w-md-auto">Тип</th> <th aria-colindex="3" class="w-md-auto">Количество</th> <th aria-colindex="4" class="w-md-auto">IP</th> <th aria-colindex="5" class="w-md-auto">Статус</th></tr></thead>
                            <tbody>
                            ...
                            <tr aria-rowindex="0">
                                ...
                                <th aria-colindex="5" class="w-md-auto">
                                    Получено
                                </th>
                            </tr>
                            @endforeach
